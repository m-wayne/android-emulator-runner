...
| `pre-emulator-termination-script` | Optional | N/A | custom script to run after tests and before terminating the emulator - e.g. `./pull-screenshots-from-emulator.sh` |
